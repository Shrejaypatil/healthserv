...
conn=mysql.connector.connect(host="remotemysql.com",user="0dUfVC8t7r",password="TAKfeIrJwu",database="0dUfVC8t7r")
cursor=conn.cursor()
...
def predict():
 if request.method == 'POST':
    ...
    if output == 1:
        return render_template("parkinson_s.html", predict_text='Parkinson’s Disease Detected',cor="red",pentered=input_features,length=len(input_features),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
    elif output == 0:
        return render_template("parkinson_s.html", predict_text='Parkinson’s Disease Not Detected',cor="green",pentered=input_features,length=len(input_features),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
    else:
...
def resultH():
    if request.method == 'POST':
        ...
        users = cursor.fetchall()
        if output2 == 1:
            return render_template('heart.html', predict_text='Heart Disease Detected',cor="red",pentered=input_features2,length=len(input_features2),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        elif output2 == 0:
            return render_template('heart.html', predict_text='Heart Disease Not Detected',cor="green",pentered=input_features2,length=len(input_features2),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        else:
...
def resultL():
    if request.method == 'POST':
        ...
        users = cursor.fetchall()
        if output3 == 1:
            return render_template('liver.html', predict_text='liver Disease Detected',cor="red",pentered=input_features3,length=len(input_features3),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        elif output3 == 2:
            return render_template('liver.html', predict_text='liver Disease Not Detected',cor="green",pentered=input_features3,length=len(input_features3),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        else:
...
def resultD():
    if request.method == 'POST':
        ...
        users = cursor.fetchall()
        if output5 == 1:
            return render_template('sugar.html', predict_text='Diabetes Detected',cor='red',pentered=input_features5,length=len(input_features5),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        elif output5 == 0:
            return render_template('sugar.html', predict_text='Diabetes Not Detected',cor='green',pentered=input_features5,length=len(input_features5),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        else:
...
def resultC():
    if request.method == 'POST':
        ...
        users = cursor.fetchall()
        if output4 == 0:
            return render_template('cancer.html', predict_text='Benign Tumor Detected',cor="green",pentered=input_features4,length=len(input_features4),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        elif output4 == 1:
            return render_template('cancer.html', predict_text='Malignant Tumor Detected',cor="red",pentered=input_features4,length=len(input_features4),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        else:
...
def resultK():
    if request.method == 'POST':
        ...
        if output5 == 0:
            return render_template('kidney.html', predict_text='Chronic KIdney Disease Not Detected',cor="green",pentered=input_features5,length=len(input_features5),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        elif output5 == 1:
            return render_template('kidney.html', predict_text='Chronic KIdney Disease Detected',cor="red",pentered=input_features5,length=len(input_features5),kcol=allcol,email=users[0][2],name=users[0][1],dob=users[0][4],mobile=users[0][5],blood=users[0][6])
        else:
